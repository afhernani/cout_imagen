...
trabajando con formato netpbm en ascii.
...
clase Imagen. - Aunque estas explicaciones están hechas con c++, aquí hemos
utilizado el c# - aunque también lo puedes encontrar en c++ con el nombre de
proyecto first.